...
<head>
    ...
    .container input[type="nama"],
    .container input[type="kelas"] {
      width: 100%;
      padding: 10px;
      margin-bottom: 15px;
      border: 1px solid #ccc;
...
<div class="navbar">
    ...
    <div class="container mt-5">
        <h3 class="mb-4">Form Pendaftaran Pengguna</h3>
        <form method="POST" action="../controller/c_user.php?aksi=tambah">
